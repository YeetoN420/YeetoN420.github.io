...
let buttonscrpt1 = "Go A";

let buttonscript2 = "Go B";
...
<img alt="T-Spawn" src="/T-Spawn.jpg">

<button class="choice-button" on:click={()=>choice1()}>{buttonscrpt1}</button>

<button class="choice-button" on:click={()=>choice2()}>{buttonscript2}</button>
